...
if (proyectoUrl) {
  proyectoUrl.addEventListener('click', function () {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        var id = proyectoUrl.dataset.id;
        axios["delete"]("/proyectos/".concat(id)).then(function (response) {
          Swal.fire({
            position: 'center',
            icon: 'success',
...
__webpack_require__(/*! ./Proyectos */ "./resources/js/Proyectos.js");
